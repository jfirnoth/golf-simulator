...
function my_keydown(e)
{
	...
	if((ball_x==hole_x)&&(ball_y==hole_y))
	{
		...
		document.getElementById("hd3").innerHTML="Congratulations, You Have Hit The Goal And Possibly Won!";
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("When the Down arrow key is pressed, Y = " + ball_y + " , X +"+ball_x);
			canvas.remove(ball_obj);
			new_image();
		}
	}
